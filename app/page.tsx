...
export default function Home() {
  ...
  const sortedCategories = useMemo(() => {
    const searchFiltered = filteredCategories(search);

    const pinned = searchFiltered.filter((cat) => cat.pinned);
    const unpinned = searchFiltered.filter((cat) => !cat.pinned);
  ...
  const pinnedCount = useMemo(
    () => data.categories.filter((cat) => cat.pinned).length,
    [data.categories],
  );
        ...
        >
          <TopBar>
            <TitleSection>
              ...
              <Subtitle
                ...
                transition={{ delay: 0.4 }}
              >
                Gerencie e organize seus conteúdos - Fixe até 3 categorias no
                topo
              </Subtitle>
            </TitleSection>
          ...
          >
            ...
            <StatCard
              ...
              transition={{ type: "spring", stiffness: 300 }}
            >
              <StatValue>{pinnedCount}/3</StatValue>
